...
public abstract class ShowUADataReportPage  extends SearchPage {
	...
	public abstract void setUa(String name);
	...
	public Collection<HibernateExpression> getSearchExpressions() {
		...
		if(StringUtils.isNotEmpty(getUa())){
			hibernateExpressions.add(new CompareExpression("ua",
					"%"+getUa()+"%", CompareType.Like));
		}
	...
	public IBasicTableModel getTableModel() {
		return new IBasicTableModel() {
			public int getRowCount() {
				return getResourceStatService().getUaReportResultCount(
			...
			public Iterator getCurrentPageRows(int nFirst, int nPageSize,
				...
				pageNo++;
				return getResourceStatService().findUaReportBy(pageNo,
