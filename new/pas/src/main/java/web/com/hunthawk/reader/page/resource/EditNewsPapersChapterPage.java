...
public abstract class EditNewsPapersChapterPage extends EditPage implements
	...
	protected boolean persist(Object object) {
		try {
			NewsPapersChapter chapter = (NewsPapersChapter) object;
			String errorMessage = "";
			...
			{	
				...
				List<NewsPapersChapter> chapterList = getResourceService().getResourceChapter(NewsPapersChapter.class, getResourceAll().getId());//得到按照序号排序的List集合
				int i=0;
				int totalsize=0;
	...
	public String getPreAddress() {
		// 得到资源中的图片
		NewsPapersChapter chapter = (NewsPapersChapter) getModel();
