 ...
 */
@Entity
@Table(name = "reader_partner_channel_child")
public class ChannelChild  extends PersistentObject{

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2711561419083518990L;
	...
	@Column(name = "channel_bussiness_type_id",nullable=false)
