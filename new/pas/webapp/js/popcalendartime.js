function atCalendarControl(){
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   calendar.calendarClose.title="关闭 快捷键:ESC";
...
/************** 加入功能按钮公共样式 *********************/
  ...
  this.show=function(targetObject,returnTime,defaultDate,sourceObject){
   ...
   var offsetTop = document.getElementById("container").scrollTop;
   if((document.body.offsetHeight-(offsetPos.y+calendar.source.offsetHeight-document.body.scrollTop))<calendar.calendarPad.style.pixelHeight){
	//alert(offsetPos.y + calendar.source.offsetHeight - offsetTop);
	if (offsetPos.y + calendar.source.offsetHeight - offsetTop < calendar.calendarPad.style.pixelHeight)
	{
		var calTop=offsetPos.y + calendar.source.offsetHeight - offsetTop;		
	} else {
		var calTop=offsetPos.y-calendar.calendarPad.style.pixelHeight-calendar.source.offsetHeight - offsetTop;
	}
