...
public abstract class ShowColumnStatPage extends SearchPage {
	...
	public Collection<HibernateExpression> getSearchExpressions() {
		...
		hibernateExpressions.add(new CompareExpression("statType",13,CompareType.Equal));
	...
	public ITableColumn getColumnname() {
		return new SimpleTableColumn("columnname", "栏目名称",
				new ITableColumnEvaluator() {
					...
					public Object getColumnValue(ITableColumn objColumn,
						...
						DataReport obj = (DataReport) objRow;
						try {
							Columns column = getBussinessService().getColumn(Integer.parseInt(obj.getParaCd()));
