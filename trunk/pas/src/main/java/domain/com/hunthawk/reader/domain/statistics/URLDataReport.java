 ...
 */
@Entity
@Table(name = "STATISTICS_URL_DATA_REPORT")
public class URLDataReport extends PersistentObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = -175108819424762839L;
