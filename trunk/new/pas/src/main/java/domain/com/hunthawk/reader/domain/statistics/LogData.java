...
public class LogData extends PersistentObject{
	...
	private String requestHourTime;
	...
	@Column(name = "request_hour")
	public String getRequestHourTime() {
		return requestHourTime;
	}

	public void setRequestHourTime(String requestHourTime) {
		this.requestHourTime = requestHourTime;
	}
