...
public abstract class EditComicsChapterPage extends EditPage implements
	...
	protected boolean persist(Object object) {
		try {
			ComicsChapter chapter = (ComicsChapter) object;
			String errorMessage = "";
			...
			{	
				...
				List<ComicsChapter> chapterList = getResourceService().getResourceChapter(ComicsChapter.class, getResourceAll().getId());//得到按照序号排序的List集合
				int i=0;
				int totalsize=0;
	...
	public String getPreAddress() {
		// 得到资源中的图片
		ComicsChapter chapter = (ComicsChapter) getModel();
