...
public class TestResource {
	...
	public static void main(String[] args){
		...
		VideoSearchService vs = (VideoSearchService)ctx.getBean("videoSearchService");
		System.out.println(vs.searchCount("5000", "刘"));
		System.out.println(vs.search("5000", "刘", 1, 3, "id", false));
