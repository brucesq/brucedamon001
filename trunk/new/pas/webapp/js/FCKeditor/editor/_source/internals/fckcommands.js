...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'Image'		: oCommand = new FCKDialogCommand( 'Image'		, FCKLang.DlgImgTitle			, FCKConfig.FullBasePath.replace("js/FCKeditor/editor/","") + 'guide/PAMSImage.page'		, 450, 400 ) ; break ;
