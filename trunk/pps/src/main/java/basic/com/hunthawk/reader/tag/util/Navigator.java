package com.hunthawk.reader.tag.util;
...
public class Navigator {
	 ...
	 */
	public Navigator(int list,int currentPage,int pagesize,int navinum) {
		this.list = list;
...
//	}
	private void init()
	{
		if(list == null || list == 0)
		{
			...
			pageCount = (int)Math.ceil((double)list/(double)pagesize);
