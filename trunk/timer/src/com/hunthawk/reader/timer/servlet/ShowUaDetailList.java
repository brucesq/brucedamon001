 ...
 *
 */
public class ShowUaDetailList extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String shortUA=request.getParameter("shortUA");
		int pageNo = 0;
		int pageSize = 0;
		try {
		...
		Page result = statisticsUAService.findUaDetailByShortUa(shortUA, pageNo, pageSize);
		...
		request.getRequestDispatcher("./showUaDetailList.jsp").forward(request,
				response);
	}
